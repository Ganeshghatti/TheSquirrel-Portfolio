...
function Title() {
  return (
    <div className=" flex flex-col  w-[95%]">
      <div className=" self-start ml-auto pb-20 w-1/2 flex flex-col justify-center">
        <div className="flex lg:ml-20  md:pr-32 flex-col text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black">
          <span>LET'S</span>
          <span>CONNECT</span>
        </div>
      </div>
...
const Box = () => {
  ...
  const inputBaseClasses =
    "outline-none border-b pb-4 hover:border-black hover:placeholder-black transition-all duration-500 ease-in-out text-4xl font-light";
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <span className="w-fit font-medium mb-2 text-4xl md:text-7xl">
          CONTACT US!
        </span>
      </button>
    </form>
  ...
  return (
    <div className=" mt-[300px] w-[95%]  flex  flex-col-reverse sm:flex-row justify-center">
      ...
      <div className=" flex flex-col sm:w-[50%] ml-auto ">
        <h4 className="font-bold text-5xl sm:text-6xl lg:text-7xl mb-10">
          The Squirrel
        </h4>
...
function Link({ href, title }) {
  ...
  return (
    <a onClick={(e) => handleClick(e, href)} href={`#${href}`}>
      {title}
    </a>
  );
}
